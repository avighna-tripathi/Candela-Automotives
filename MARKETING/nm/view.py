...
def view():                                                            #coding to view the stats of Newspaper & Magazine
       while True:
              ...
              print(' 2. By the name of each daily.')
              ...
              if choice==1:
                     ...
                     reader2.remove(l)
                     i=len(reader2)
                     name=input("Enter the name of the daily whose information and deal you want to view :")
                     for j in range(0,i):
                            if reader2[j][0]==name:
                                   t=reader2[j]
                                   print(l)
                            ...
                            print(" Record related to the entered daily's name not found!!!")
                     print()
                     print()
                     print()
                     print("------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
